...
if mua2 == 0
    ...
    phit = (sinh(alpha1*(zb + z0)) ./ (d1timesalpha1)) .* ((d1timesalpha1.*cosh(alphatimesell) + d2timesalpha2.*sinh(alphatimesell)) ...
        ./ (d1timesalpha1.*cosh(alpha1*(ell+zb)) + d2timesalpha2.*sinh(alpha1*(ell+zb)))) - sinh(alpha1*z0)./(d1timesalpha1);
