...
for db1 = Db1
    for db2 = Db2
        for l = ell;
            ...
            [dbbeta25(i,1) a1(i,1)] = fminsearchbnd(@(x) twolayercostonlydb2(x, ell, 0.5 ,g2_25,n,Reff,mua1,mus1,calcdb1,tau25,lambda,rho2,w,mua2,mus2, gl),guessc(1),lbc(1),ubc(1));
