...
input = single(zeros(siz,size(tau,2)*10));
...
for db1 = Db1s
    ...
    for ratio = Ratio1
        for l = ells
            ...
            gamma = 1/tau(index10);
            sigma10 = getDCSNoise(300e3,T,inttime,beta,gamma,tau);
            ...
            gamma = 1/tau(index15);
            nsep15 = getDCSNoise(150e3,T,inttime,beta,gamma,tau); %50 hz.
            ...
            nsep20 = getDCSNoise(40e3,T,inttime,beta,gamma20,tau); %50 hz.
            ...
            gamma = 1/tau(index25);
            sigma25 = getDCSNoise(15e3,T,inttime,beta,gamma,tau);
            ...
            for rep = 1:Rep
                ...
                input(j,:) = single([g2_30a(:)' g2_25 g2_20 g2_15 g2_10]);
